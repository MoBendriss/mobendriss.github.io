(function () {
    ...
    function revealChildren(panel) {
        var items = panel.querySelectorAll(".resource-item, .abstract-box, .empty-note, .info-item, .faq-item, .level-title");
    ...
    document.querySelectorAll(".nav-link").forEach(function (btn) {
        ...
        btn.addEventListener("keydown", function (e) {
            var currentId = btn.getAttribute("data-tab");
            var idx = TAB_IDS.indexOf(currentId);
            if (idx === -1) return;
            var newIdx = null;
            ...
            if (newIdx !== null) {
                ...
                var newBtn = document.getElementById("tab-" + TAB_IDS[newIdx]);
                if (newBtn) newBtn.focus();
            }
        });
    });

    /* DATA-OPEN-TAB BUTTONS */
    ...
    var I18N = {
        ...
        ar: {
            ...
            "hero.start": "ابدأ",
            "hero.research": "البحث العلمي",
            "stats.cycles": "أسلاك تعليمية",
            "stats.resources": "موارد قابلة للتطوير",
            ...
            "filter.recherche": "بحث علمي",
            "filter.favorites": "المفضلة",
            "filter.noResults": "لم يتم العثور على نتائج.",
            "faq.heading": "الأسئلة الشائعة",
            "faq.q1": "كيف أحمّل وثيقة؟",
            "faq.a1": "انقر على زر « تحميل » الخاص بالمورد المطلوب.",
            "faq.q2": "هل الموارد مجانية؟",
            "faq.a2": "نعم، جميع الموارد مجانية ومفتوحة للاستعمال التربوي.",
            "faq.q3": "كيف أتواصل معك؟",
            "faq.a3": "استخدم استمارة لسان « اتصال ».",
            "contact.heading": "اتصال",
            "contact.intro": "لأي سؤال أو تعاون، تواصل معي.",
            "contact.nameLabel": "الاسم",
            "contact.emailLabel": "البريد الإلكتروني",
            "contact.messageLabel": "الرسالة",
            "contact.submit": "إرسال",
            "legal.heading": "الخصوصية",
            "legal.privacy1": "لا يتم جمع أي بيانات شخصية خارج استمارة الاتصال.",
            ...
            "sidebar.researchBtn": "البحث العلمي",
            "sidebar.newsTitle": "آخر المستجدات",
            "sidebar.newBadge": "جديد",
            "sidebar.news1": "نشر موارد خاصة بالمستوى الإعدادي.",
